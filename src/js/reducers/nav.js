...
const initialState = {
  ...
  items: [
    ...
    // { path: path_prefix + '/lc', label: 'Lifecycle', icon: Cycle},
    { path: path_prefix + '/respools', label: 'Server pools', icon: ServerCluster},
    { path: path_prefix + '/deploy', label: 'Deployment', icon: Deploy},
    { path: path_prefix + `/env`, label: 'Environments', icon: Network},
    { path: path_prefix + `/images`, label: 'Image Store', icon: Storage},
    { path: path_prefix + `/kickstarts`, label: 'Scripts', icon: Code},
    { path: path_prefix + `/rm`, label: 'Resource Managers', icon: Resources},
