...
import {
  ...
  Footer,
  Button,
  Select, Text, RadioButtonGroup, Tabs, Tab, TableCell, Table, TableHeader, TableBody, TableRow, Layer, TextInput
} from 'grommet';
      ...
      <Form  pad='large'>
        ...
        <div>
          ...
          <FormField label="Log File Path">
            <Text margin="small">{settings.logFilePath}</Text>
          </FormField>
          <br/>
  ...
  render() {
    ...
    return (
      <Box id="settings" fill="vertical" overflow="auto" align="start" flex="grow"
        ...
        <Tabs>
          <Tab title="General Settings" icon={<SettingsOption/>}>
